...
public class Runner {
    ...
    public static void main(String[] args) {
        Airport allPlanesAirport = new Airport(allPlanes);
        Airport militaryAirport = new Airport(allPlanesAirport.getMilitaryPlanes());
        Airport passengerAirport = new Airport(allPlanesAirport.getPassengerPlanes());
